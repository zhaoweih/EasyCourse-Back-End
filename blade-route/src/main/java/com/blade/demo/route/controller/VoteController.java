...
import com.blade.demo.route.model.vote.NewVote;
import com.blade.demo.route.model.vote.Select;
import com.blade.demo.route.model.vote.Vote;
...
public class VoteController {
    ...
    public RestResponse queryVote(@Param Integer courseId) {
        ...
        while(voteIterator.hasNext()) {
            ...
            vote.setSelectList((List<Select>) gson.fromJson(json, new TypeToken<List<Select>>() {
            }.getType()));
